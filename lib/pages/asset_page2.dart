...
class Asset2Overview extends StatefulWidget {
  const Asset2Overview({Key? key}) : super(key: key);

  @override
  _Asset2OverviewState createState() => _Asset2OverviewState();
}

class _Asset2OverviewState extends State<Asset2Overview> {
  @override
  ...
  _launchURL() async {
    Uri url = Uri.parse("https://discord.com/invite/XVKK6hX");
